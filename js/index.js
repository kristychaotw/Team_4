...
function calculateGoB(weatherData){
    ...
    if(GoB <= 4){
        recommendation = {
            "good": [trip, "外出吃美食", "欣賞歷史古蹟", "購物振興經濟", "到南部玩", "洗衣曬被", "做好防曬", "吃冰淇淋", "遊山玩水", "到柴山看猴子", "帶狗狗出門玩", "參加朋友聚會", "去有冷氣的地方", "尋找九天玄女", "外出打莫德納"],
            "bad": ["睡一整天", "叫 foodPanda", "在家寫程式", "在家吃泡麵", "網購逛蝦皮", "看 Netflix", "用功讀書", "刷 Leetcode", "看 104","睡到快長高", "刷 CodeForce", "忽略熱指數","在陽光下太久", "騎摩托車", "看他人進度報告"],
        }
    }else if(GoB >4 && GoB <7){
        recommendation = {
            "good": ["睡到十點", "超市買泡麵", "看彭彭 YT 教學", "素顏出門", "不洗頭", "出門逛街", "吃飽睡，睡飽吃", "喝下午茶", "看電影", "唱歌", "看 Udemy 課程", "逛書店", "去酒吧喝酒", "等垃圾車", "家樂福坐按摩椅"],
            "bad": ["睡到中午", "出門太久", "去海邊玩", "去基隆玩", "騎車出門", "出門不帶雨傘", "看悲傷電影", "忽略紫外線指數", "與人爭執", "出門不帶錢包", "不參加朋友聚會", "下車輸贏", "吸收太多咖啡因", "紅包錢給太少", "與他人比較"],
        }
    }else{
        recommendation = {
            "good": ["叫 foodPanda", "躺在床上一整天", "睡到自然醒", "什麼事都不做", "看 Netflix", "熬夜寫程式", "吸狗吸貓吸兔子", "開喝", "玩桌遊", "搶 PS5", "玩 Switch", "看 Disney+", "看直播抖內", "在家當肥宅", "買刮刮樂"],
            "bad": ["外出覓食", "換下睡衣", "3C 產品沒電", "離開床超過一小時", "戶外運動", "曬衣服", "修剪花草", "搬家", "登山衝浪", "泛舟", "帶狗狗出門", "騎車上班", "到垃圾", "上班/上學", "早睡！"],
        }
    }
